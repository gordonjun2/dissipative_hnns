...
def load_model(args, hidden_dim, mode):
    if mode == 'MLP':
    ...
    path = "{}/2body-satellite-orbits-DHNN-step=40000.tar".format(args.save_dir)
...
args.save_dir = './experiment_satellite/pretrained_weights'
args.name = '2body'
args.label = mode

args.satellite_case = True
